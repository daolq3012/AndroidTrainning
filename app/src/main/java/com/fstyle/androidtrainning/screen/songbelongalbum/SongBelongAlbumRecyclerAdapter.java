...
public class SongBelongAlbumRecyclerAdapter
        extends RecyclerView.Adapter<SongBelongAlbumRecyclerAdapter.RecyclerViewHolder> {

    private List<Track> mTracks = new ArrayList<>();
    private Context mContext;

    public SongBelongAlbumRecyclerAdapter(Context context) {
        mContext = context;
    }
